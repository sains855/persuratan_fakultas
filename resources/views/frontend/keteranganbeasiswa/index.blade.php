    ...
    <div style="min-height: 50vh" class="flex flex-col bg-gray-50">
        ...
        <main class="flex-grow flex items-center justify-center">
            <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-md">
                <h2 class="text-2xl font-bold text-gray-700 mb-6 text-center">Form Cek NIM - Keterangan Beasiswa</h2>
                ...
                {{-- Flash info --}}
                @if (session('info'))
                    <div class="auto-hide mb-6 p-4 bg-blue-50 border border-blue-200 text-blue-700 rounded-lg flex items-start justify-between">
                        <div class="flex-1">
                ...
                <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <p class="text-sm text-gray-600 mt-2">
                        Silakan masukkan NIM Anda untuk mengecek data mahasiswa dan mengisi form keterangan beasiswa.
                    </p>
                </div>
