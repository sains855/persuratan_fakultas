...
@if(session('success'))
                    ...
                    <tbody class="text-gray-700 text-sm bg-white">
                        @forelse ($Ttd as $data)
                            <tr class="border-b border-gray-200 hover:bg-blue-50 transition">
                                ...
                                <td class="px-4 py-3 align-top">{{ $data->{'pangkat/gol'} }}</td>
                ...
                @forelse ($Ttd as $data)
                    <div class="bg-white rounded-lg border border-blue-200 shadow-sm p-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="text-sm text-gray-600 text-center">
                                <strong>Pangkat/Gol:</strong> {{ $data->{'pangkat/gol'} }}
                            </div>
                        </div>
        ...
        <div class="bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto p-4 sm:p-6 relative transform scale-95 opacity-0 transition-all duration-300"
            ...
            <form method="POST" action="{{ route('ttd.store') }}" enctype="multipart/form-data" class="space-y-4" id="formTtd">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-600 mb-2">Pangkat/Gol <span class="text-red-500">*</span></label>
                        <input type="text" name="pangkat/gol" value="{{ old('pangkat/gol') }}"
                            class="w-full border border-blue-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:border-blue-400 text-sm">
                        @error('pangkat/gol')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const inputs = ['nip', 'nama', 'jabatan', 'pangkat/gol', 'foto'];
            inputs.forEach(inputName => {
                ...
                if (input) {
                    ...
                    input.addEventListener(eventType, function() {
                        ...
                        // Validasi real-time untuk foto
                        if (inputName === 'foto' && this.files.length > 0) {
